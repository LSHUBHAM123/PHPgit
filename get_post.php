...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="/phpshubh/get_post.php">Get-Post</a>
...
if ($_SERVER['REQUEST_METHOD']=='POST'){  //used to check if server method Post or not 
    ...
    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>Success!!</strong>
    The Email is '. $email .' and the Password is '. $pass.' 
...
?>
  ...
  <div class="container">
  <form action="/phpshubh/get_post.php" method="post">
